...
$configScenarios = @'
[{"name":"Default","description":"","name_values":[{"name":"collections","value":["Groups","Membersh
ips","OrganizationalUnits","Users"]},{"name":"domain","value":null},{"name":"multi_searchbases","val
ue":false},{"name":"nr_of_sessions","value":null},{"name":"password","value":null},{"name":"resultpa
gesize","value":"0"},{"name":"searchbase","value":"*"},{"name":"searchbases","value":[]},{"name":"se
rver","value":null},{"name":"sessions_idle_timeout","value":null},{"name":"use_specific_server","val
ue":null},{"name":"use_svc_account_creds","value":null},{"name":"username","value":null}],"collectio
ns":[{"col_name":"Groups","fields":[{"field_name":"objectGUID","field_type":"string","include":true,
"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fiel
ds":[]},{"field_name":"distinguishedName","field_type":"string","include":true,"field_format":"","fi
eld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name"
:"GroupCategory","field_type":"string","include":true,"field_format":"","field_source":"data","javas
cript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"GroupScope","field_type
":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refe
rence":false,"ref_col_fields":[]},{"field_name":"cn","field_type":"string","include":true,"field_for
mat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"
field_name":"objectClass","field_type":"string","include":true,"field_format":"","field_source":"dat
a","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"path","field_t
ype":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"r
eference":false,"ref_col_fields":[]},{"field_name":"sAMAccountName","field_type":"string","include":
true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col
_fields":[]},{"field_name":"objectSid","field_type":"string","include":true,"field_format":"","field
_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]}],"key":"objectGU
ID","display":"sAMAccountName","name_values":[],"sys_nn":[],"source":"data"},{"col_name":"Membership
s","fields":[{"field_name":"group","field_type":"string","include":true,"field_format":"","field_sou
rce":"data","javascript":"","ref_col":["Groups"],"reference":false,"ref_col_fields":[]},{"field_name
":"member","field_type":"string","include":true,"field_format":"","field_source":"data","javascript"
:"","ref_col":["Users","Groups"],"reference":false,"ref_col_fields":[]}],"key":"","display":"member"
,"name_values":[],"sys_nn":[{"field_a":"group","col_a":"Groups","field_b":"member","col_b":"Groups"}
,{"field_a":"group","col_a":"Groups","field_b":"member","col_b":"Users"}],"source":"data"},{"col_nam
e":"OrganizationalUnits","fields":[{"field_name":"objectGUID","field_type":"string","include":true,"
field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_field
s":[]},{"field_name":"c","field_type":"string","include":true,"field_format":"","field_source":"data
","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"distinguishedNa
me","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","re
f_col":[],"reference":true,"ref_col_fields":[]},{"field_name":"gPLink","field_type":"string","includ
e":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_
col_fields":[]},{"field_name":"l","field_type":"string","include":true,"field_format":"","field_sour
ce":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"manage
dBy","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","r
ef_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"ou","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"objectClass","field_type":"string","include":true,"field_format":"","fi
eld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name"
:"path","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":""
,"ref_col":[],"reference":false,"ref_col_fields":[{"col":"OrganizationalUnits","field":"distinguishe
dName"}]},{"field_name":"postalCode","field_type":"string","include":true,"field_format":"","field_s
ource":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"st"
,"field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_c
ol":[],"reference":false,"ref_col_fields":[]},{"field_name":"streetAddress","field_type":"string","i
nclude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,
"ref_col_fields":[]}],"key":"objectGUID","display":"distinguishedName","name_values":[],"sys_nn":[],
"source":"data"},{"col_name":"Users","fields":[{"field_name":"objectGUID","field_type":"string","inc
lude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"r
ef_col_fields":[]},{"field_name":"accountExpires","field_type":"string","include":true,"field_format
":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"fie
ld_name":"adminDescription","field_type":"string","include":true,"field_format":"","field_source":"d
ata","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"adminDisplay
Name","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","
ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"c","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"CannotChangePassword","field_type":"boolean","include":true,"field_form
at":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"f
ield_name":"canonicalName","field_type":"string","include":true,"field_format":"","field_source":"da
ta","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"ChangePasswor
dAtLogon","field_type":"boolean","include":true,"field_format":"","field_source":"data","javascript"
:"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"cn","field_type":"string","in
clude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"
ref_col_fields":[]},{"field_name":"co","field_type":"string","include":true,"field_format":"","field
_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"c
ompany","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":""
,"ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"countryCode","field_type":"numbe
r","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":f
alse,"ref_col_fields":[]},{"field_name":"createTimeStamp","field_type":"date","include":true,"field_
format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]}
,{"field_name":"department","field_type":"string","include":true,"field_format":"","field_source":"d
ata","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"description"
,"field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_c
ol":[],"reference":false,"ref_col_fields":[]},{"field_name":"displayName","field_type":"string","inc
lude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"r
ef_col_fields":[]},{"field_name":"distinguishedName","field_type":"string","include":true,"field_for
mat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"
field_name":"division","field_type":"string","include":true,"field_format":"","field_source":"data",
"javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"employeeID","fiel
d_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[]
,"reference":false,"ref_col_fields":[]},{"field_name":"employeeNumber","field_type":"string","includ
e":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_
col_fields":[]},{"field_name":"employeeType","field_type":"string","include":true,"field_format":"",
"field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_na
me":"Enabled","field_type":"boolean","include":true,"field_format":"","field_source":"data","javascr
ipt":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"givenName","field_type":"
string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"referen
ce":false,"ref_col_fields":[]},{"field_name":"homeDirectory","field_type":"string","include":true,"f
ield_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields
":[]},{"field_name":"homeDrive","field_type":"string","include":true,"field_format":"","field_source
":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"homePhon
e","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref
_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"initials","field_type":"string","incl
ude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"re
f_col_fields":[]},{"field_name":"info","field_type":"string","include":true,"field_format":"","field
_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"i
pPhone","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":""
,"ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"l","field_type":"string","includ
e":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_
col_fields":[]},{"field_name":"lastLogon","field_type":"string","include":true,"field_format":"","fi
eld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name"
:"lastLogonTimestamp","field_type":"string","include":true,"field_format":"","field_source":"data","
javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"mail","field_type"
:"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refer
ence":false,"ref_col_fields":[]},{"field_name":"manager","field_type":"string","include":true,"field
_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[{
"col":"Users","field":"distinguishedName"}]},{"field_name":"middleName","field_type":"string","inclu
de":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref
_col_fields":[]},{"field_name":"mobile","field_type":"string","include":true,"field_format":"","fiel
d_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"
name","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","
ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"objectClass","field_type":"string"
,"include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":fal
se,"ref_col_fields":[]},{"field_name":"objectSid","field_type":"string","include":true,"field_format
":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"fie
ld_name":"pager","field_type":"string","include":true,"field_format":"","field_source":"data","javas
cript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"PasswordExpirationDate"
,"field_type":"date","include":true,"field_format":"yyyy-mm-dd (local)","field_source":"data","javas
cript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"PasswordNeverExpires","
field_type":"boolean","include":true,"field_format":"","field_source":"data","javascript":"","ref_co
l":[],"reference":false,"ref_col_fields":[]},{"field_name":"PasswordNotRequired","field_type":"boole
an","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":
false,"ref_col_fields":[]},{"field_name":"path","field_type":"string","include":true,"field_format":
"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[{"col":"Or
ganizationalUnits","field":"distinguishedName"}]},{"field_name":"physicalDeliveryOfficeName","field_
type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"
reference":false,"ref_col_fields":[]},{"field_name":"primaryGroupID","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"postalCode","field_type":"string","include":true,"field_format":"","fie
ld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":
"postOfficeBox","field_type":"string","include":true,"field_format":"","field_source":"data","javasc
ript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"profilePath","field_type
":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refe
rence":false,"ref_col_fields":[]},{"field_name":"proxyAddresses","field_type":"string","include":tru
e,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fi
elds":[]},{"field_name":"roomNumber","field_type":"string","include":true,"field_format":"","field_s
ource":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"sAM
AccountName","field_type":"string","include":true,"field_format":"","field_source":"data","javascrip
t":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"scriptPath","field_type":"s
tring","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"referenc
e":false,"ref_col_fields":[]},{"field_name":"sn","field_type":"string","include":true,"field_format"
:"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"fiel
d_name":"st","field_type":"string","include":true,"field_format":"","field_source":"data","javascrip
t":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"streetAddress","field_type"
:"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refer
ence":false,"ref_col_fields":[]},{"field_name":"telephoneNumber","field_type":"string","include":tru
e,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fi
elds":[]},{"field_name":"title","field_type":"string","include":true,"field_format":"","field_source
":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"userPrin
cipalName","field_type":"string","include":true,"field_format":"","field_source":"data","javascript"
:"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"whenCreated","field_type":"da
te","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":
false,"ref_col_fields":[]},{"field_name":"wWWHomePage","field_type":"string","include":true,"field_f
ormat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]}]
,"key":"objectGUID","display":"sAMAccountName","name_values":[{"name":"filter","value":"*"},{"name":
"properties","value":["accountExpires","adminDescription","adminDisplayName","c","CannotChangePasswo
rd","canonicalName","ChangePasswordAtLogon","cn","co","company","countryCode","createTimeStamp","dep
artment","description","displayName","distinguishedName","division","employeeID","employeeNumber","e
mployeeType","Enabled","givenName","homeDirectory","homeDrive","homePhone","info","initials","ipPhon
e","l","lastLogon","lastLogonTimestamp","mail","manager","middleName","mobile","name","objectClass",
"objectGUID","objectSid","pager","PasswordExpirationDate","PasswordNeverExpires","PasswordNotRequire
d","path","physicalDeliveryOfficeName","postalCode","postOfficeBox","primaryGroupID","profilePath","
proxyAddresses","roomNumber","sAMAccountName","scriptPath","sn","st","streetAddress","telephoneNumbe
r","title","userPrincipalName","whenCreated","wWWHomePage"]}],"sys_nn":[],"source":"data"}]}]
'@
