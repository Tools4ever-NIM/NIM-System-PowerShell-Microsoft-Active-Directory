...
$configScenarios = @'
[{"name":"Default","description":"4 tables: Groups, Memberships, OrganizationalUnits, Users","versio
n":"1.0","createTime":1739221859251,"modifyTime":1739221859251,"name_values":[{"name":"collections",
"value":["Groups","Memberships","OrganizationalUnits","Users"]},{"name":"domain","value":null},{"nam
e":"multi_searchbases","value":false},{"name":"nr_of_sessions","value":null},{"name":"password","val
ue":null},{"name":"resultpagesize","value":"0"},{"name":"searchbase","value":"*"},{"name":"searchbas
es","value":[]},{"name":"server","value":null},{"name":"sessions_idle_timeout","value":null},{"name"
:"use_specific_server","value":null},{"name":"use_svc_account_creds","value":null},{"name":"username
","value":null}],"collections":[{"col_name":"Groups","fields":[{"field_name":"objectGUID","field_typ
e":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"ref
erence":false,"ref_col_fields":[]},{"field_name":"distinguishedName","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"GroupCategory","field_type":"string","include":true,"field_format":"","
field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_nam
e":"GroupScope","field_type":"string","include":true,"field_format":"","field_source":"data","javasc
ript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"cn","field_type":"string
","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":fa
lse,"ref_col_fields":[]},{"field_name":"objectClass","field_type":"string","include":true,"field_for
mat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"
field_name":"path","field_type":"string","include":true,"field_format":"","field_source":"data","jav
ascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"sAMAccountName","fiel
d_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[]
,"reference":false,"ref_col_fields":[]},{"field_name":"objectSid","field_type":"string","include":tr
ue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_f
ields":[]}],"key":"objectGUID","display":"sAMAccountName","name_values":[],"sys_nn":[],"source":"dat
a"},{"col_name":"Memberships","fields":[{"field_name":"group","field_type":"string","include":true,"
field_format":"","field_source":"data","javascript":"","ref_col":["Groups"],"reference":false,"ref_c
ol_fields":[]},{"field_name":"member","field_type":"string","include":true,"field_format":"","field_
source":"data","javascript":"","ref_col":["Users","Groups"],"reference":false,"ref_col_fields":[]}],
"key":"","display":"member","name_values":[],"sys_nn":[{"field_a":"group","col_a":"Groups","field_b"
:"member","col_b":"Groups"},{"field_a":"group","col_a":"Groups","field_b":"member","col_b":"Users"}]
,"source":"data"},{"col_name":"OrganizationalUnits","fields":[{"field_name":"objectGUID","field_type
":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refe
rence":false,"ref_col_fields":[]},{"field_name":"c","field_type":"string","include":true,"field_form
at":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"f
ield_name":"distinguishedName","field_type":"string","include":true,"field_format":"","field_source"
:"data","javascript":"","ref_col":[],"reference":true,"ref_col_fields":[]},{"field_name":"gPLink","f
ield_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col"
:[],"reference":false,"ref_col_fields":[]},{"field_name":"l","field_type":"string","include":true,"f
ield_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields
":[]},{"field_name":"managedBy","field_type":"string","include":true,"field_format":"","field_source
":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"ou","fie
ld_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[
],"reference":false,"ref_col_fields":[]},{"field_name":"objectClass","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"path","field_type":"string","include":true,"field_format":"","field_sou
rce":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[{"col":"OrganizationalU
nits","field":"distinguishedName"}]},{"field_name":"postalCode","field_type":"string","include":true
,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fie
lds":[]},{"field_name":"st","field_type":"string","include":true,"field_format":"","field_source":"d
ata","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"streetAddres
s","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref
_col":[],"reference":false,"ref_col_fields":[]}],"key":"objectGUID","display":"distinguishedName","n
ame_values":[],"sys_nn":[],"source":"data"},{"col_name":"Users","fields":[{"field_name":"objectGUID"
,"field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_c
ol":[],"reference":false,"ref_col_fields":[]},{"field_name":"accountExpires","field_type":"string","
include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false
,"ref_col_fields":[]},{"field_name":"adminDescription","field_type":"string","include":true,"field_f
ormat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},
{"field_name":"adminDisplayName","field_type":"string","include":true,"field_format":"","field_sourc
e":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"c","fie
ld_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[
],"reference":false,"ref_col_fields":[]},{"field_name":"CannotChangePassword","field_type":"boolean"
,"include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":fal
se,"ref_col_fields":[]},{"field_name":"canonicalName","field_type":"string","include":true,"field_fo
rmat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{
"field_name":"ChangePasswordAtLogon","field_type":"boolean","include":true,"field_format":"","field_
source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"cn
","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_
col":[],"reference":false,"ref_col_fields":[]},{"field_name":"co","field_type":"string","include":tr
ue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_f
ields":[]},{"field_name":"company","field_type":"string","include":true,"field_format":"","field_sou
rce":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"count
ryCode","field_type":"number","include":true,"field_format":"","field_source":"data","javascript":""
,"ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"createTimeStamp","field_type":"d
ate","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference"
:false,"ref_col_fields":[]},{"field_name":"department","field_type":"string","include":true,"field_f
ormat":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},
{"field_name":"description","field_type":"string","include":true,"field_format":"","field_source":"d
ata","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"displayName"
,"field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_c
ol":[],"reference":false,"ref_col_fields":[]},{"field_name":"distinguishedName","field_type":"string
","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":tr
ue,"ref_col_fields":[]},{"field_name":"division","field_type":"string","include":true,"field_format"
:"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"fiel
d_name":"employeeID","field_type":"string","include":true,"field_format":"","field_source":"data","j
avascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"employeeNumber","fi
eld_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":
[],"reference":false,"ref_col_fields":[]},{"field_name":"employeeType","field_type":"string","includ
e":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_
col_fields":[]},{"field_name":"Enabled","field_type":"boolean","include":true,"field_format":"","fie
ld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":
"givenName","field_type":"string","include":true,"field_format":"","field_source":"data","javascript
":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"homeDirectory","field_type":
"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refere
nce":false,"ref_col_fields":[]},{"field_name":"homeDrive","field_type":"string","include":true,"fiel
d_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[
]},{"field_name":"homePhone","field_type":"string","include":true,"field_format":"","field_source":"
data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"initials","
field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col
":[],"reference":false,"ref_col_fields":[]},{"field_name":"info","field_type":"string","include":tru
e,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fi
elds":[]},{"field_name":"ipPhone","field_type":"string","include":true,"field_format":"","field_sour
ce":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"l","fi
eld_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":
[],"reference":false,"ref_col_fields":[]},{"field_name":"lastLogon","field_type":"string","include":
true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col
_fields":[]},{"field_name":"lastLogonTimestamp","field_type":"string","include":true,"field_format":
"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field
_name":"mail","field_type":"string","include":true,"field_format":"","field_source":"data","javascri
pt":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"manager","field_type":"str
ing","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference"
:false,"ref_col_fields":[{"col":"Users","field":"distinguishedName"}]},{"field_name":"middleName","f
ield_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col"
:[],"reference":false,"ref_col_fields":[]},{"field_name":"mobile","field_type":"string","include":tr
ue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_f
ields":[]},{"field_name":"name","field_type":"string","include":true,"field_format":"","field_source
":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"objectCl
ass","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","r
ef_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"objectSid","field_type":"string","i
nclude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,
"ref_col_fields":[]},{"field_name":"pager","field_type":"string","include":true,"field_format":"","f
ield_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name
":"PasswordExpirationDate","field_type":"date","include":true,"field_format":"yyyy-mm-dd (local)","f
ield_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name
":"PasswordNeverExpires","field_type":"boolean","include":true,"field_format":"","field_source":"dat
a","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"PasswordNotReq
uired","field_type":"boolean","include":true,"field_format":"","field_source":"data","javascript":""
,"ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"path","field_type":"string","inc
lude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"r
ef_col_fields":[{"col":"OrganizationalUnits","field":"distinguishedName"}]},{"field_name":"physicalD
eliveryOfficeName","field_type":"string","include":true,"field_format":"","field_source":"data","jav
ascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"primaryGroupID","fiel
d_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[]
,"reference":false,"ref_col_fields":[]},{"field_name":"postalCode","field_type":"string","include":t
rue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_
fields":[]},{"field_name":"postOfficeBox","field_type":"string","include":true,"field_format":"","fi
eld_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name"
:"profilePath","field_type":"string","include":true,"field_format":"","field_source":"data","javascr
ipt":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"proxyAddresses","field_ty
pe":"string-array","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":
[],"reference":false,"ref_col_fields":[]},{"field_name":"roomNumber","field_type":"string","include"
:true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_co
l_fields":[]},{"field_name":"sAMAccountName","field_type":"string","include":true,"field_format":"",
"field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_na
me":"scriptPath","field_type":"string","include":true,"field_format":"","field_source":"data","javas
cript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"sn","field_type":"strin
g","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":f
alse,"ref_col_fields":[]},{"field_name":"st","field_type":"string","include":true,"field_format":"",
"field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_na
me":"streetAddress","field_type":"string","include":true,"field_format":"","field_source":"data","ja
vascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"telephoneNumber","fi
eld_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":
[],"reference":false,"ref_col_fields":[]},{"field_name":"title","field_type":"string","include":true
,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fie
lds":[]},{"field_name":"userPrincipalName","field_type":"string","include":true,"field_format":"","f
ield_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name
":"whenCreated","field_type":"date","include":true,"field_format":"","field_source":"data","javascri
pt":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"wWWHomePage","field_type":
"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"refere
nce":false,"ref_col_fields":[]}],"key":"objectGUID","display":"sAMAccountName","name_values":[{"name
":"filter","value":"*"},{"name":"properties","value":["accountExpires","adminDescription","adminDisp
layName","c","CannotChangePassword","canonicalName","ChangePasswordAtLogon","cn","co","company","cou
ntryCode","createTimeStamp","department","description","displayName","distinguishedName","division",
"employeeID","employeeNumber","employeeType","Enabled","givenName","homeDirectory","homeDrive","home
Phone","info","initials","ipPhone","l","lastLogon","lastLogonTimestamp","mail","manager","middleName
","mobile","name","objectClass","objectGUID","objectSid","pager","PasswordExpirationDate","PasswordN
everExpires","PasswordNotRequired","path","physicalDeliveryOfficeName","postalCode","postOfficeBox",
"primaryGroupID","profilePath","proxyAddresses","roomNumber","sAMAccountName","scriptPath","sn","st"
,"streetAddress","telephoneNumber","title","userPrincipalName","whenCreated","wWWHomePage"]}],"sys_n
n":[],"source":"data"}]}]
'@
